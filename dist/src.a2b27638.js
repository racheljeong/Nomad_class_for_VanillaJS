...
var numFromUserInput = document.querySelector("#random-num input");
//const numFromUserVal = numFromUserInput.value; //숫자 최대 범위위
var guessInput = document.querySelector("#guessInput");
var submitBtn = document.getElementById("submitBtn"); //play 버튼
var resultText = document.getElementById("resultText"); //result값 들어올 div
...
function submitEvent(e) {
  ...
  var numFromUser = numFromUserInput.value;
  var guessNumUser = guessInput.value;
  ...
  resultText.innerText = "You chose : ".concat(guessNumUser, ", the machine chose : ").concat(randomNum);
